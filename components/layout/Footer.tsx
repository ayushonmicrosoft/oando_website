        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-8">
          ...
          <div className="md:col-span-2 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 mt-2">
              <a
                href="https://www.linkedin.com/company/oando-furniture"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/oandofurniture"
                target="_blank"
                rel="noopener noreferrer"
          ...
          {/* Nav columns */}
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-10 md:gap-8">
            {NAV.map((col) => (
              <div key={col.heading}>
